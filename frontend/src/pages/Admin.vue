...
export default {
    ...
    methods: {
        async deletePrize(username) {
            try {
                const res = await fetch('http://176.114.67.27/api/deletePrize', {
                    method: 'DELETE',
                    headers: {
        ...
        async getUserPrizes() {
            try {
                const res = await fetch('http://176.114.67.27/api/getUserPrizes', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        async submitQuantity() {
            if(this.form.quantity.length === 0 || this.form.username.length === 0) {
                ...
                try {
                    const res = await fetch('http://176.114.67.27/api/addQuantity', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
        ...
        async submitUser() {
            ...
            || this.formReg.password.length < 3) {
                ...
                try {
                const res = await fetch('http://176.114.67.27/api/addUser', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
